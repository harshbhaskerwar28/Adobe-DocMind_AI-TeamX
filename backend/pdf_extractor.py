...
async def generate_podcast_recommendations() -> PodcastRecommendationsResponse:
    """
    Generate AI-powered podcast recommendations based on user's document library
    Uses Gemini 2.0 Flash Exp and vector database content
    """
    try:
...
async def pdf_chat(request: PDFChatRequest):
    """
    Chat with PDF content using Gemini 2.5 Flash Pro
