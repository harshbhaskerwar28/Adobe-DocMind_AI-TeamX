...
# Note: catch-all frontend route is registered at the end of the file to avoid
# intercepting API endpoints like /health
...
# Catch-all route for SPA routing placed at the end to avoid shadowing API routes like /health
@app.get("/{path:path}")
